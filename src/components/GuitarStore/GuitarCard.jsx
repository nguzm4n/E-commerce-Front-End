...
const GuitarCard = ({ img, name, price , Onclick, seeDetails}) => {
    ...
    return (
        <>
            <div className="card mx-5 mt-5 border-dark rounded-1" style={{width: "18rem"}}>
                <img src={img} className="card-img-top mt-4 guitar-img" alt="..." onClick={seeDetails}/>
                <div className="card-body text-center">
                    <h5 className="card-title guitar-name fw-semibold fs-5 ">{name}</h5>

		...
		actions: {
			...
			signUp: async (credenciales) => {
				try {
					...
					const response = await fetch(`https://e-commerce-back-end-production-1b0b.up.railway.app/signup`, option)
			...
			getStrat: async () => {
				try {
					const url = 'https://e-commerce-back-end-production-1b0b.up.railway.app/getstrat';
					const options = {
						method: "GET",
			...
			getGuitarId: async (guitarId, navigate) => {
				try {
					const url = `https://e-commerce-back-end-production-1b0b.up.railway.app/getguitarid/${guitarId}`;
					const options = {
						method: "GET",
						headers: { 'Content-Type': 'application/json' }
					}
			...
			getAllGuitars: async () => {
				try {
					const url = 'https://e-commerce-back-end-production-1b0b.up.railway.app/getall';
					const options = {
						method: "GET",
						headers: { 'Content-Type': 'application/json' }
					}
			...
			addItem: (id) => {
				...
				const url = `https://e-commerce-back-end-production-1b0b.up.railway.app/cart/add/${id}`;
				const options = {
					method: "POST",
					headers: {
						'Content-Type': 'application/json',
			...
			decreaseItem: (id) => {
				...
				const url = `https://e-commerce-back-end-production-1b0b.up.railway.app/cart/item/${id}/decrement`;
				const options = {
					method: "POST",
					headers: {
						'Content-Type': 'application/json',
			...
			deleteItem: (id) => {
				const { access_token } = getStore()
				const url = `https://e-commerce-back-end-production-1b0b.up.railway.app/cart/remove/${id}`
				const options = {
					method: 'DELETE',
					headers: {
						'Content-Type': 'application/json',
			...
			getCart: async () => {
				try {
					const { access_token } = getStore()
					const url = 'https://e-commerce-back-end-production-1b0b.up.railway.app/cart';
					const options = {
						method: "GET",
						headers: {
							'Content-Type': 'application/json',
			...
			searchItem: async (itemName, navigate) => {
				try {
					...
					const response = await fetch(`https://e-commerce-back-end-production-1b0b.up.railway.app/search`, options);
					const datos = await response.json();
			...
			createOrder: async (navigate) => {
				...
				try {
					...
					const response = await fetch('https://e-commerce-back-end-production-1b0b.up.railway.app/order', options);
					const data = await response.json();
			...
			getAllOrders: async () => {
				try {
					const { access_token } = getStore();
					const url = 'https://e-commerce-back-end-production-1b0b.up.railway.app/userorders';
					const options = {
						method: "GET",
						headers: {
							'Content-Type': 'application/json',
			...
			fetchOrderDetails: async (orderId, navigate) => {
				...
				try {
					const response = await fetch(`https://e-commerce-back-end-production-1b0b.up.railway.app/order/${orderId}`, {
						method: 'GET',
						headers: {
							'Content-Type': 'application/json',
							'Authorization': `Bearer ${access_token}`
			...
			deleteOrder: (id) => {
				const { access_token } = getStore()
				const url = `https://e-commerce-back-end-production-1b0b.up.railway.app/delete/order/${id}`
				const options = {
					method: 'DELETE',
					headers: {
						'Content-Type': 'application/json',
			...
			getAllUsers: async () => {
				const { access_token } = getStore()
				try {
					const url = 'https://e-commerce-back-end-production-1b0b.up.railway.app/admin/users';
					const options = {
						method: "GET",
						headers: {
							'Content-Type': 'application/json',
			...
			searchUser: async (searchTerm) => {
				try {
				  ...
				  const response = await fetch('https://e-commerce-back-end-production-1b0b.up.railway.app/admin/search_user', {
					method: 'POST',
					headers: {
					  'Content-Type': 'application/json',
					  'Authorization': `Bearer ${access_token}` 
			  ...
			  getUserOrders: async (userId,navigate) => {
				...
				try {
				  ...
				  const response = await fetch(`https://e-commerce-back-end-production-1b0b.up.railway.app/admin/user_orders/${userId}`, {
					method: 'GET',
					headers: {
					  'Content-Type': 'application/json',
					  'Authorization': `Bearer ${access_token}` 
			  ...
			  AdminDeleteOrder: (orderId, userId) => {
				const { access_token } = getStore()
				const url = `https://e-commerce-back-end-production-1b0b.up.railway.app/admin/order/${orderId}/${userId}`
				const options = {
					method: 'DELETE',
					headers: {
						'Content-Type': 'application/json',
